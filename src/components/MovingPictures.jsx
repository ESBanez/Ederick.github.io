...
const Logos = [
        ...
        },
        {
            name: "instagram",
            id: 4,
            path: "https://www.gizmochina.com/wp-content/uploads/2020/10/Instagram-Logo.png",
            alt: "instagram logo",
        },
        {
            name: "vercel",
        ...
        },
        {
            name: "github",
            id: 6,
            path: "https://www.spanishnewsnow.com/wp-content/uploads/2021/09/Como-configurar-las-compilaciones-automaticas-para-las-imagenes-de-Docker-en-GitHub.png",
            alt: "github logo",
        },
        {
            name: "vite",
        ...
        },
        {
            name: "sass",
            id: 14,
            path: "https://www.ma-no.org/cache/galleries/contents-787/460-300/sass-css-mediaqueries.jpg",
            alt: "sass logo",
        },
        {
            name: "mysql",
...
function MovingPictures() {
    useEffect(() => {
      ...
      const sliderInterval = setInterval(animateSlider, 1);
